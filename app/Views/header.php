...
<header>
    <div class="menu">
        <ul>
            <li class="logo">
                <a href="https://www.studeffi.com" target="_blank">
            ...
            <li class="menu-item hidden"><a href="#">Element 1</a></li>
            <li class="menu-item hidden"><a href="">Element 2</a>
            </li>
            <li class="menu-item hidden"><a href="">Element 3</a></li>
